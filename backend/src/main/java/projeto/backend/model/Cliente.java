...
public class Cliente {
    ...
    public Cliente(String nome, String cpf, LocalDate dataNascimento, String telefone, Double salario, String funcao, Usuario usuario, Endereco endereco, Cliente cliente){
        this.nome = nome;
        this.cpf = cpf;
